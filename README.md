...
The repository also contains the basic files to start the NLP Project based on the Zindi's challenge To Vaccinate or Not to Vaccinate.
...
**Notebook.ipynb** - is a starter notebook to help you make your first submission on this challenge.
